...
def _decision_summary(row: V4ShadowDecision) -> dict:
    return {
        ...
        "provenance": {
            ...
            # Model/reasoning provenance (2026-09-02). llm_model is the
            # configured alias; llm_returned_model what the API reported.
            "llm_returned_model": row.llm_returned_model,
            ...
            "llm_reasoning_tokens": row.llm_reasoning_tokens,
            "llm_cache_hit_tokens": row.llm_cache_hit_tokens,
            "llm_latency_ms": row.llm_latency_ms,
            "llm_config_version": row.llm_config_version,
